...
const Hero: React.FC<HeroProps> = ({ heroImage }) => {
  const finalImage = heroImage || IMAGES.heroMain;
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <div className="animate-fade-up opacity-0 space-y-6 mb-12" style={{animationDelay: '500ms'}}>
              <p className="text-slate-100 text-lg md:text-xl font-bold leading-relaxed max-w-xl mx-auto lg:mx-0 drop-shadow-md">
              ...
              <div className="flex flex-col gap-4 items-center lg:items-start">
                <div className="flex items-center gap-3 text-white font-extrabold text-base md:text-lg transition-transform hover:translate-x-2 duration-300 drop-shadow-sm">
                  <div className="bg-green-500/30 backdrop-blur-sm p-1.5 rounded-full">
